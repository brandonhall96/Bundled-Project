...
exports.EuiDataGridBody = exports.Cell = exports.VIRTUALIZED_CONTAINER_CLASS = void 0;
...
function getParentCellContent(_element) {
...
var EuiDataGridBody = function EuiDataGridBody(props) {
  ...
  var headerRow = (0, _react.useMemo)(function () {
    return /*#__PURE__*/_react.default.createElement(_header.EuiDataGridHeaderRow, {
      ref: setHeaderRowRef,
  ...
  var preventTabbing = (0, _react.useCallback)(function (records) {
    ...
    for (var i = 0; i < records.length; i++) {
      ...
      if (cell) {
        ...
        for (var _i5 = 0; _i5 < tabbables.length; _i5++) {
          var element = tabbables[_i5];
