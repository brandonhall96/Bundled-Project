...
function wrapLines(nodes, options) {
  ...
  grouped.forEach(function (node, i) {
    ...
    var children = options.showLineNumbers ? [{
      ...
      }, _defineProperty(_properties, 'data-line-number', i + 1), _defineProperty(_properties, 'aria-hidden', true), _defineProperty(_properties, "className", ['euiCodeBlock__lineNumber']), _properties),
      children: []
    }, {
      type: 'element',
      tagName: 'span',
