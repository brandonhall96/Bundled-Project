...
var tint = function tint(color, ratio) {
  return _chromaJs.default.mix(color, '#fff', ratio, 'rgb').css();
};
/**
...
var shade = function shade(color, ratio) {
  return _chromaJs.default.mix(color, '#000', ratio, 'rgb').css();
};
/**
...
var saturate = function saturate(color, amount) {
  return (0, _chromaJs.default)(color).set('hsl.s', "+".concat(amount)).css();
};
/**
