...
var IS_JEST_ENVIRONMENT = global.hasOwnProperty('_isJest'); // Each gridStyle object above sets a specific CSS select to .euiGrid
...
function useVirtualizeContainerWidth(resizeRef, pageSize) {
  ...
  var virtualizeContainer = resizeRef === null || resizeRef === void 0 ? void 0 : resizeRef.getElementsByClassName(_body.VIRTUALIZED_CONTAINER_CLASS)[0]; // re-render data grid on size changes
...
var EuiDataGrid = function EuiDataGrid(props) {
  ...
  var _useState15 = (0, _react.useState)(false),
      ...
      headerIsInteractive = _useState16[0],
      setHeaderIsInteractive = _useState16[1];
  ...
  var _useState17 = (0, _react.useState)(null),
      ...
      resizeRef = _useState18[0],
      setResizeRef = _useState18[1];

  var _useState19 = (0, _react.useState)(null),
      _useState20 = (0, _slicedToArray2.default)(_useState19, 2),
      toolbarRef = _useState20[0],
      setToolbarRef = _useState20[1];
  ...
  var _useDataGridColumnSel = (0, _column_selector.useDataGridColumnSelector)(columns, columnVisibility, (0, _data_grid_toolbar.checkOrDefaultToolBarDisplayOptions)(toolbarVisibility, 'showColumnSelector'), displayValues),
  ...
  var _useState21 = (0, _react.useState)(null),
      ...
      contentRef = _useState22[0],
      setContentRef = _useState22[1];
  ...
  var _useState23 = (0, _react.useState)(new _row_height_utils.RowHeightUtils()),
      _useState24 = (0, _slicedToArray2.default)(_useState23, 1),
      rowHeightUtils = _useState24[0];
  ...
  return /*#__PURE__*/_react.default.createElement(_data_grid_context.DataGridFocusContext.Provider, {
    ...
    ref: setResizeRef
  }, rest), (IS_JEST_ENVIRONMENT || defaultColumnWidth) && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, showToolbar && /*#__PURE__*/_react.default.createElement(_data_grid_toolbar.EuiDataGridToolbar, {
    ...
    role: "grid",
    id: gridId
  }, wrappingDivFocusProps, gridAriaProps), /*#__PURE__*/_react.default.createElement(_body.EuiDataGridBody, {
    isFullScreen: isFullScreen,
    ...
    id: ariaLabelledById,
    hidden: true
  }, ariaLabelledBy), props.pagination && /*#__PURE__*/_react.default.createElement(_data_grid_pagination.EuiDataGridPaginationRenderer, (0, _extends2.default)({}, props.pagination, {
    rowCount: props.rowCount,
    controls: gridId,
