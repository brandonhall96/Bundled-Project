...
import { schemaDetectors as providedSchemaDetectors, useDetectSchema, useMergedSchema } from './data_grid_schema';
import { checkOrDefaultToolBarDisplayOptions, EuiDataGridToolbar } from './data_grid_toolbar';
import { RowHeightUtils } from './row_height_utils';
import { startingStyles, useDataGridStyleSelector } from './style_selector'; // Used to short-circuit some async browser behaviour that is difficult to account for in tests
...
export var EuiDataGrid = function EuiDataGrid(props) {
  ...
  var _useState23 = useState(new RowHeightUtils()),
  ...
  return /*#__PURE__*/React.createElement(DataGridFocusContext.Provider, {
    ...
    ref: setResizeRef
  }, rest), (IS_JEST_ENVIRONMENT || defaultColumnWidth) && /*#__PURE__*/React.createElement(React.Fragment, null, showToolbar && /*#__PURE__*/React.createElement(EuiDataGridToolbar, {
    ...
    id: ariaLabelledById,
    hidden: true
  }, ariaLabelledBy), props.pagination && /*#__PURE__*/React.createElement(EuiDataGridPaginationRenderer, _extends({}, props.pagination, {
    rowCount: props.rowCount,
    controls: gridId,
